      ...
      {!q && (
        <section className="grid gap-4 sm:grid-cols-3 mt-4">
          <div className="border-2 border-border bg-bg-surface p-6">
            ...
            <p className="text-sm text-fg-muted">Find books by title, author, or ISBN</p>
          </div>
          <div className="border-2 border-border bg-bg-surface p-6">
            ...
            <p className="text-sm text-fg-muted">See when you&apos;ll finish based on your reading speed</p>
          </div>
          <div className="border-2 border-border bg-bg-surface p-6">
            ...
            <p className="text-sm text-fg-muted">Set up weekly email nudges to stay on track</p>
          </div>
        </section>
      )}
    </div>
